...
type Client interface {
	...
	GetModel(ctx context.Context, modelID string, provider domain.Provider) (*Model, error)
...
func WithProvider(provider domain.Provider, config ProviderConfig) ClientOption {
	return func(c *ClientConfig) {
		if c.Providers == nil {
			c.Providers = make(map[domain.Provider]ProviderConfig)
		}
